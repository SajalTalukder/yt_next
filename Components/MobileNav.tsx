...
const MobileNav = ({ nav, closeNav }: Props) => {
  const navStyle = nav ? "translate-y-0" : "translate-y-[-100%] ";
  return (
    <div
      className={`fixed ${navStyle} transform transition-all duration-300 top-0 left-0 right-0 bottom-0 z-[10000] bg-[#200f31]`}
    >
